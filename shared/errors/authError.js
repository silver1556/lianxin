...
class AuthError extends AppError {
   ...
   */
  static phoneVerificationRequired(
  ...
  /**
   * Static method to create user not found error
   */
  static userNotFound(message = "User not found", userId = null) {
    return new AuthError(message, 404, "USER_NOT_FOUND", { userId });
  }
  ...
  static verificationFailed(
    ...
    return new AuthError(message, 401, "VERIFICATION_FAILED", {
      verificationId,
    });
  }
