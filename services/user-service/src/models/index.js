...
const UserProfile = require("./user_profile.model")(sequelize);
...
const UserPrivacySettings = require("./user_privacy_settings.model")(sequelize);
...
User.hasMany(UserPrivacySettings, {
  foreignKey: "user_id",
  as: "privacySettings",
  onDelete: "CASCADE",
});
