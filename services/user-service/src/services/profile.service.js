const { User, UserProfile, UserPrivacySettings } = require("../models");
...
class ProfileService {
    ...
    try {
      const profile = await UserProfile.findOne({
        ...
        include: [
          ...
          { model: UserPrivacySettings, as: "privacySettings" },
        ],
      });
  ...
  async updateUserProfile(userId, profileData) {
    try {
      ...
      // --- Reload to get latest values, including defaults, JSON fields, etc. ---
      const updatedProfile = await userProfile.reload();
